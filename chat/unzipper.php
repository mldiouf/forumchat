<?php
/**
 * Le décompresseur extrait les archives .zip ou .rar et les fichiers .gz sur les serveurs Web
 * C'est pratique si vous n'avez pas accès au shell. Par exemple. si vous voulez télécharger beaucoup
 * de fichiers (framework php ou collection d'images) en tant qu'archive pour gagner du temps.
 * Depuis la version 0.1.0, il prend également en charge la création d'archives.
 *
...
if (isset($_POST['dounzip'])) {
  // Vérifiez si une archive a été sélectionnée pour être décompressée.
